...
% TODO: Cloud testbed
% Number of VMs, VM resources, comparison to other experimental setups (re marks feedback)
% Hadoop and Stratosphere versions
...
% Implementation concerns - what is the Map and Reduce, etc.
\section{PageRank}
% Implementation concerns - what is the DAG, etc. Code modified from Stratosphere project and NICTA
